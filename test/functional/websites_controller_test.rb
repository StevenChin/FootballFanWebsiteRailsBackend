...
class WebsitesControllerTest < ActionController::TestCase
  ...
  test "should create website" do
    assert_difference('Website.count') do
      post :create, website: { likes: @website.likes, name: @website.name, site_id: @website.site_id, url: @website.url }
    end
  ...
  test "should update website" do
    put :update, id: @website, website: { likes: @website.likes, name: @website.name, site_id: @website.site_id, url: @website.url }
    assert_redirected_to website_path(assigns(:website))
  end
